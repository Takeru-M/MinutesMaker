...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("meeting_scale", sa.String(255), nullable=False),
        sa.Column("minutes_scope_policy", sa.String(255), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("scope_type", sa.String(255), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("actor_role_snapshot", sa.String(255), nullable=True),
